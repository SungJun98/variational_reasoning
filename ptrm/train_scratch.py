...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stage", default="ptrm_scratch")
    ...
    parser.add_argument("--lr-warmup-steps", type=int, default=600)
    parser.add_argument("--beta1", type=float, default=0.9)
    parser.add_argument("--beta2", type=float, default=0.95)
    parser.add_argument("--weight-decay", type=float, default=1.0)
    parser.add_argument("--puzzle-emb-lr", type=float, default=1e-4)
    parser.add_argument("--puzzle-emb-weight-decay", type=float, default=1.0)

    parser.add_argument("--ivon-ess", type=float, default=1e7)
    parser.add_argument("--ivon-hess-init", type=float, default=1.0)
    parser.add_argument("--ivon-beta2", type=float, default=0.99)
    parser.add_argument("--ivon-weight-decay", type=float, default=1e-4)
    parser.add_argument("--ivon-clip-radius", type=float, default=0.2)
    ...
    parser.add_argument("--ivon-noise-scale", type=float, default=0.275)
    ...
    parser.add_argument("--act-mode", choices=("normal", "fixed_depth", "delayed_fixed_depth"), default="delayed_fixed_depth")
    parser.add_argument("--loss-mode", choices=("full", "token_only", "delayed_token_only"), default="delayed_token_only")
    parser.add_argument("--delay-act-steps", type=int, default=2500)
    ...
    parser.add_argument("--wandb-project", default="ptrm-ivon-from-scratch")
...
def main() -> None:
    ...
    last_metrics = None
    utils.update_status(status_path, f"Started scratch training at step {start_step}; target stop_step={stop_step}.")
    ...
    try:
        ...
        utils.update_status(status_path, f"Completed scratch training. Saved checkpoint: {public_checkpoint}.")
        if wandb_run is not None:
